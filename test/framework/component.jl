...
module Calls
    ...
    module Plv_b
        using ..Calls: Value
        using EcologicalNetworksDynamics.Framework: Blueprint, define_blueprint
    ...
    @testset "Calls to `define_component()`." begin
        ...
        addfails.@missingrequired((s + Zjz.b()), _Cvh, _Zjz, [Zjz_b], nothing)
        ...
        s = System{Value}()
        addfails.@missingrequired((s + Lev.b()), _Dsy, _Lev, [Lev_b], nothing)
        s += Dsy.b() + Lev.b()
...
module Abstracts
    ...
    using EcologicalNetworksDynamics.Framework:
        F, Blueprint, Component, System, define_blueprint, has_component

    using EcologicalNetworksDynamics.Tests: addfails
    using Test
    ...
    @testset "Abstract component types semantics." begin
        ...
        addfails.@missingrequired(S(Ahv_b()), A, _Ahv, [Ahv_b], nothing)
