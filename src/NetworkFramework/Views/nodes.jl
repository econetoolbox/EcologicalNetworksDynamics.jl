...
Parametrized by SubnodesData dispatcher.
"""
struct SubnodesDataView{d,T} <: AbstractSparseVector{T,Int}
    model::Model
    view::N.NodesView{T}
end
...
AbstractNodesDataView{d,T} = Union{NodesDataView{d,T},SubnodesDataView{d,T}}
